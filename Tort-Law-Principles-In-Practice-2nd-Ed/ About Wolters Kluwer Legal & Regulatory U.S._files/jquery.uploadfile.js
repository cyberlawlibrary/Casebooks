            ...
            var options = {
                ...
                error: function (xhr, status, errMsg) {
                    ...
                    if (xhr.statusText == "abort") //we aborted it
                    {
                        ...
                        s.onError.call(this, xhr, status, errMsg);
                        if (s.showStatusAfterError) {
                            pd.progressDiv.hide();
                            pd.statusbar.append("<p class='error-label-accesscode'>" + xhr.responseJSON.errorMessg + "</p>");
							if(xhr.responseJSON.genericParam !== undefined)
								pd.statusbar.append("<p class='error-label-accesscode'>Incorrect code(s): " + xhr.responseJSON.genericParam + "</p>");
                        } else {
                            pd.statusbar.hide();
                            pd.statusbar.remove();
                        }
    ...
    function fileUploadIframe(a) {
        ...
        function cb(e) {
            ...
            if (status === 'success') {
                ...
                if (errMsg === undefined) {
                    errMsg = xhr.responseJSON.errorMessg;
                }
                if (s.error) {
